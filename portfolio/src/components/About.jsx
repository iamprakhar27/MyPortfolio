function About() {
    return ( 
        <>
        <div className="relative h-screen w-full flex flex-col md:flex-row items-start justify-start bg-gray-800 p-8 bg-contain bg-left bg-no-repeat" style={{ backgroundImage: "url('/images/img3.jpg')" }}>
